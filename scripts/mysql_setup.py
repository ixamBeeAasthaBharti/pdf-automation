...
def add_html_storage_columns():
    """Safely add gemini_html and script_html columns to htmltopdfautomation."""
    conn   = get_connection()
    cursor = conn.cursor()
    for col, definition in [
        ("gemini_html", "LONGTEXT DEFAULT NULL COMMENT 'HTML content generated by Gemini'"),
        ("script_html", "LONGTEXT DEFAULT NULL COMMENT 'HTML content generated by Layout Script'"),
    ]:
        try:
            cursor.execute(
                f"ALTER TABLE htmltopdfautomation ADD COLUMN {col} {definition}"
...
if __name__ == "__main__":
    ...
    add_html_storage_columns()          # safe: adds gemini_html and script_html
